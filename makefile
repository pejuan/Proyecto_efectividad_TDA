tda:	main.o integer.o object.o tdalist.o node.o fsarraylist.o slinkedlist.o cursor.o slnode.o
	g++ main.o integer.o node.o object.o tdalist.o fsarraylist.o slinkedlist.o slnode.o cursor.o -o tda
